				...
				<div class="col-xs-6 col-md-6">
					<form role="form" id="queryForm" class="form-horizontal">
						...
						<div class="form-group">
							  ...
							  <div class="col-sm-9">
								<input type="text" class="form-control" id="category" name="category" ng-model="query_Resource.queryItem.category" placeholder="<@spring.message "resource.category.placeholder"/>">
							  </div>
						</div>
