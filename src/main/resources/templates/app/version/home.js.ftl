...
app.controller('appCtl', function($scope, $http) {
	...
	$scope.getData = function(){
		var listUrl = "${base}/app/version/list.do?size=" + $scope.pageSize + "&page=" + $scope.pageIndex;
	...
	$scope.createConfirm = function(){
		$.ajax({
			cache: true,
			type: 'POST',
			url: "${base}/app/version/create.do",
	...
	$scope.deleteConfirm = function(){
		...
		$.ajax({
			cache: true,
			type: 'POST',
			url: "${base}/app/version/delete.do",
