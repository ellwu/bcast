$scope.$watch('createItem.province', function(newVal){
	
	if(newVal){
		for(var i in $scope.provinceList){
			if($scope.provinceList[i].name == newVal){
...
$scope.$watch('createItem.city', function(newVal){
	
	if(newVal){
		for(var i in $scope.cityList){
			if($scope.cityList[i].name == newVal){
...
$scope.$watch('editItem.province', function(newVal){
...
$scope.$watch('editItem.city', function(newVal){
