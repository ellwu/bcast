...
<html lang="en">
	<head>
		<@html.commonHead/>
		<title><@spring.message "adver.home.title"/></title>
	...
	<body>
		<div ng-app="myApp" ng-controller="appCtl">
			...
			<@html.content>
				...
				<#include "/adver/create.ftl"/>
				
				<#include "/adver/edit.ftl"/>
				
				<#include "/adver/delete.ftl"/>
				
			</@html.content>
			
			<script src="${base}/res.do?path=/adver/home.js"></script>
		</div>
	</body>
</html>