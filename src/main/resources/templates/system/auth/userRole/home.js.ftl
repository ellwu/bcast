...
app.controller('appCtl', function($scope, $http) {
	...
	$scope.getData = function(){
		var listUrl = "${base}/userRole/list.do?size=" + $scope.pageSize + "&page=" + $scope.pageIndex;
	...
	$scope.optionsInit = function(){
		var optionsUrl = "${base}/user/options.do";
	    
	    $http.get(optionsUrl).success(function (response) {
	    	$scope.options.userOptions = response;
	    });
	    
	    optionsUrl = "${base}/role/options.do";
