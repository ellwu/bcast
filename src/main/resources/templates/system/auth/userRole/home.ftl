...
<html lang="en">
	<head>
		<@html.commonHead/>
		<title><@spring.message "userRole.home.title"/></title>
	...
	<body>
		<div ng-app="myApp" ng-controller="appCtl">
			...
			<@html.content>
					...
					<div class="panel-body">
						...
						<div class="table-responsive">
					  	<table class="table table-bordered">
							<thead> 
								<tr> 
									<th><@spring.message "userRole.user.head"/></th> 
									<th><@spring.message "userRole.role.head"/></th> 
				...
				<#include "/system/auth/userRole/create.ftl"/>
				
				<#include "/system/auth/userRole/edit.ftl"/>
				
				<#include "/system/auth/userRole/delete.ftl"/>
				
			</@html.content>
			
			<script src="${base}/res.do?path=/system/auth/userRole/home.js"></script>
		</div>
	</body>
</html>