...
<html lang="en">
	<head>
		<@html.commonHead/>
		<title><@spring.message "func.home.title"/></title>
	...
	<body>
		<div ng-app="myApp" ng-controller="appCtl">
			...
			<@html.content>
					...
					<div class="panel-body">
						...
						<div class="table-responsive">
					  	<table class="table table-bordered">
							<thead> 
								<tr> 
									<th><@spring.message "func.key.head"/></th> 
									<th><@spring.message "func.prompt.head"/></th> 
									<th><@spring.message "func.url.head"/></th> 
									<th><@spring.message "func.desc.head"/></th> 
				...
				<#include "/system/auth/func/create.ftl"/>
				
				<#include "/system/auth/func/edit.ftl"/>
				
				<#include "/system/auth/func/delete.ftl"/>
				
			</@html.content>
			
			<script src="${base}/res.do?path=/system/auth/func/home.js"></script>
		</div>
	</body>
</html>