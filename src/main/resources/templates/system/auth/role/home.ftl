	...
	<body>
		<div ng-app="myApp" ng-controller="appCtl">
			...
			<@html.content>
					...
					<div class="panel-body">
						...
						<div class="table-responsive">
					  	<table class="table table-bordered">
							<thead> 
								<tr> 
									<th><@spring.message "role.name.head"/></th> 
									<th><@spring.message "role.desc.head"/></th> 
				...
				<#include "/system/auth/role/create.ftl"/>
				
				<#include "/system/auth/role/edit.ftl"/>
				
				<#include "/system/auth/role/delete.ftl"/>
				
			</@html.content>
			
			<script src="${base}/res.do?path=/system/auth/role/home.js"></script>
		</div>
	</body>
</html>