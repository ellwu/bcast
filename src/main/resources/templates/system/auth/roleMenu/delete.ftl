   ...
   <div class="modal-dialog modal-sm">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title" id="deleteModalLabel"><@spring.message "profile.home.editMenu"/></h4>
         </div>
         <div class="modal-body">  
         	<div class="alert alert-danger" role="alert" ng-hide="deleteOk">{{ deleteMsg }}</div>  
			<p><@spring.message "prompt.delete.confirm"/> "{{deleteItem.role.name}}, {{deleteItem.menu.prompt}}" ?</p>
         </div>
