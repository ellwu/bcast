...
app.controller('appCtl', function($scope, $http) {
	...
	$scope.getData = function(){
		var listUrl = "${base}/lookup/list.do?size=" + $scope.pageSize + "&page=" + $scope.pageIndex;
	...
	$scope.optionsInit = function(){
		var optionsUrl = "${base}/category/options.do";
	    
	    $http.get(optionsUrl).success(function (response) {
	    	$scope.options.catOptions = response;
	    });
	};
