...
<html lang="en">
	<head>
		<@html.commonHead/>
		<title><@spring.message "category.home.title"/></title>
	...
	<body>
		<div ng-app="myApp" ng-controller="appCtl">
			...
			<@html.content>
				...
				<#include "/system/lookup/category/create.ftl"/>
				
				<#include "/system/lookup/category/edit.ftl"/>
				
				<#include "/system/lookup/category/delete.ftl"/>
				
			</@html.content>
			
			<script src="${base}/res.do?path=/system/lookup/category/home.js"></script>
		</div>
	</body>
</html>