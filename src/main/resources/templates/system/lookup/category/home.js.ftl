...
app.controller('appCtl', function($scope, $http) {
	...
	$scope.getData = function(){
		var listUrl = "${base}/category/list.do?size=" + $scope.pageSize + "&page=" + $scope.pageIndex;
